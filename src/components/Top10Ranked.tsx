          ...
          return (
            ...
            >
              ...
              <Link 
                ...
                onClick={handleClick}
                className="flex-1 aspect-[2/3] relative rounded-xl overflow-hidden bg-[#0a0d14] border border-white/5 shadow-2xl transition-all duration-300 hover:scale-[1.03] hover:border-primary/40 hover:shadow-[0_0_20px_rgba(0,229,255,0.15)] ml-12 sm:ml-14 touch-action-manipulation"
              >
