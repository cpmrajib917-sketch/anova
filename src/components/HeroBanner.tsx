...
import { fallbackAnimes, prefetchAnime } from '../lib/api';
      ...
      {animes.map((item, idx) => (
        ...
        >
          <img 
            ...
            className="w-full h-full object-cover object-[center_15%] opacity-70 md:opacity-45 transition-transform duration-[5000ms] ease-out bg-[#080d1a]"
