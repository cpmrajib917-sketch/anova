        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-4 relative">
            ...
            <a 
              ...
              className="p-2 text-[#0088cc] hover:text-[#00a8ff] transition-all rounded-lg hover:bg-white/5 active:scale-95 flex items-center justify-center hover:shadow-[0_0_12px_rgba(0,136,204,0.4)] group"
              title="Join Telegram Community"
            >
              <svg 
                className="w-[20px] h-[20px] fill-current transition-transform duration-200 group-hover:scale-110" 
                viewBox="0 0 24 24"
              >
