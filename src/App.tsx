...
export default function App() {
  return (
    <BrowserRouter>
      <AppSyncWrapper>
        <div className="min-h-screen bg-bg text-white selection:bg-primary selection:text-black flex flex-col justify-between overflow-x-hidden w-full max-w-full">
          <TopProgress />
          <Navigation />
          <main className="pb-12 flex-1 w-full max-w-full overflow-x-hidden">
            <Routes>
